...
print("\nImage with various target objects at same planes : \n\n")
...
if var == "y" :
    ...
    print("Left epipole (matrix form): \n", e1x)
    print("Right epipole (matrix form): \n", e2x)
...
print("\nImage with various target objects at different planes : \n\n")
